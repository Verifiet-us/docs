module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links-hover': theme('colors.zinc.950'),
      '--tw-prose-links-underline': theme('colors.zinc.500 / 0.3'),
      ...
      '--tw-prose-invert-links-hover': theme('colors.zinc.500'),
      '--tw-prose-invert-links-underline': theme('colors.zinc.500 / 0.3'),
